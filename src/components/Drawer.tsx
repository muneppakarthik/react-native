  ...
  return (
    <ScrollView
      ...
      <DrawerContentScrollView {...props} style={styles.container}>
        ...
        <TouchableOpacity
          style={styles.drawerItem}
          onPress={() => handleNavigation('notFound')}>
          <AntDesign name="meho" size={20} style={styles.icon} />
          <Text style={styles.drawerLabel}>404</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.drawerItem}
          onPress={() => handleNavigation('login')}>
          <AntDesign name="login" size={20} style={styles.icon} />
          <Text style={styles.drawerLabel}>Sign In</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.drawerItem}
          onPress={() => handleNavigation('signup')}>
          <AntDesign name="antdesign" size={20} style={styles.icon} />
          <Text style={styles.drawerLabel}>Sign Up</Text>
        </TouchableOpacity>
